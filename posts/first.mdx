...
<input type="checkbox" /> &nbsp; 검색 최적화 <br />
<input type="checkbox" /> &nbsp; 마크다운에서 이미지 사용 <br />
<input type="checkbox" /> &nbsp; Next.js 이미지 최적화(지금은 이미지 최적화 설정을
꺼놓은 상태; 2022.03.04) <br />
<input type="checkbox" /> &nbsp; 컨텐츠 그룹화(routing) -> 넋두리 & 개발 정도면 될듯..? <br />
<input type="checkbox" /> &nbsp; 기본적인 레이아웃 잡기 <br />
<input type="checkbox" /> &nbsp; 댓글, 좋아요 <br />
<input type="checkbox" /> &nbsp; 메인 배너 추가..? <br />
